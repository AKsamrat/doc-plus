...
const Footers = () => {
  return (
    <div className="bg-[#020043] text-[#fffff5cb]">
      <footer className="px-4  max-w-[1160px] mx-auto pt-[120px] pb-[136px]">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
                ...
                <a className='className="flex items-center text-3xl' href="">
                  <FaYoutube />
                </a>
              </div>
              <p className="pt-3">@docplus 2024</p>
            </div>
          </div>
        </div>
      </footer>
